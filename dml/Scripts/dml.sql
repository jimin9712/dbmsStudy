...
SELECT FIELD_TRIP_TITLE, ROUND(AVG(C.CHILD_AGE),2) AS AVG_AGE
FROM TBL_APPLY A JOIN TBL_PARENT P 
ON A.PARENT_ID = P.ID
JOIN TBL_CHILD C ON P.ID = C.PARENT_ID
JOIN TBL_FIELD_TRIP FT ON A.FIELD_TRIP_ID = FT.ID
GROUP BY FT.FIELD_TRIP_TITLE;
...
VALUES(SEQ_MEMBER.NEXTVAL, 'LJM', '1234', '이지민', '서울', 'ljm21252@naver.com', '990602');

INSERT INTO TBL_MEMBER
(ID, MEMBER_ID, MEMBER_PASSWORD, MEMBER_NAME, MEMBER_ADDRESS, MEMBER_EMAIL, MEMBER_BIRTH)
VALUES(SEQ_MEMBER.NEXTVAL, 'YHJ', '0000', '용호중', '경기도', 'YHJ714@naver.com', ' 000814');

INSERT INTO TBL_MEMBER
(ID, MEMBER_ID, MEMBER_PASSWORD, MEMBER_NAME, MEMBER_ADDRESS, MEMBER_EMAIL, MEMBER_BIRTH)
VALUES(SEQ_MEMBER.NEXTVAL, 'LSC', '1111', '이세찬', '강원도', 'LSC2142@naver.com', '001102');

INSERT INTO TBL_MEMBER
(ID, MEMBER_ID, MEMBER_PASSWORD, MEMBER_NAME, MEMBER_ADDRESS, MEMBER_EMAIL, MEMBER_BIRTH)
VALUES(SEQ_MEMBER.NEXTVAL, 'AMH', '2222', '안민혁', '강원도', 'AMH2142@naver.com', '881102');

INSERT INTO TBL_MEMBER
(ID, MEMBER_ID, MEMBER_PASSWORD, MEMBER_NAME, MEMBER_ADDRESS, MEMBER_EMAIL, MEMBER_BIRTH)
VALUES(SEQ_MEMBER.NEXTVAL, 'LUG', '3333', '이유진', '강원도', 'LUG2142@naver.com', '771102');

INSERT INTO TBL_MEMBER
(ID, MEMBER_ID, MEMBER_PASSWORD, MEMBER_NAME, MEMBER_ADDRESS, MEMBER_EMAIL, MEMBER_BIRTH)
VALUES(SEQ_MEMBER.NEXTVAL, 'JJE', '4444', '정진이', '강원도', 'JJE2142@naver.com', '661102');
...
/*3. 회원 별 좋아요 수 조회하기*/
SELECT M.MEMBER_NAME, COUNT(L.ID) AS LIKE_COUNT
FROM TBL_MEMBER M
JOIN TBL_LIKE L ON M.ID = L.LIKE_RECEIVER
GROUP BY M.MEMBER_NAME;

SELECT AVG(COUNT(L.ID)) "평균 좋아요 수"
FROM TBL_MEMBER M JOIN TBL_LIKE L
ON M.ID = L.LIKE_RECEIVER 
GROUP BY L.LIKE_RECEIVER;
...
INSERT INTO TBL_MEMBER
(ID, MEMBER_NAME)
VALUES(SEQ_MEMBER.NEXTVAL, '이지민');

SELECT * FROM TBL_MEMBER;

INSERT INTO TBL_POST
(ID, POST_TITLE, MEMBER_ID)
VALUES(SEQ_POST.NEXTVAL, '텍스트 제목1', 7);
...
INSERT INTO TBL_PARENT
(ID, PARENT_NAME, PARENT_ADDRESS, PARENT_PHONE)
VALUES(SEQ_PARENT.NEXTVAL, '김철수', '서울', '01077775234');
...
/*체험학습을 두 개 이상 신청한 부모의 아이 정보와 부모 정보 조회(단, 아이가 없는 부모의 정보도 모두 나와야 한다.)*/
...
JOIN
(
SELECT FIELD_TRIP_ID , COUNT(PARENT_ID) AS PARENT_COUNT
FROM TBL_APPLY A
GROUP BY FIELD_TRIP_ID
HAVING COUNT(PARENT_ID) = (
SELECT MIN(PARENT_COUNT)
FROM(
      SELECT FIELD_TRIP_ID, COUNT(PARENT_ID) AS PARENT_COUNT
      FROM TBL_APPLY
      GROUP BY FIELD_TRIP_ID
...
) INFO ON FT.ID = INFO.FIELD_TRIP_ID;
